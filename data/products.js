...
class Clothing extends Product {
  ...
  extraInfoHTML() {
    // super.extraInfoHTML() - gets access of parent's method
    return `
...
class Appliance extends Product {
  ...
  extraInfoHTML() {
    return `
      <a href="${this.instructionsLink}" target="_blank">Instructions chart
      </a>

      <a href="${this.warrantyLink}" target="_blank">Warranty chart
      </a>
    `;
  }
}
